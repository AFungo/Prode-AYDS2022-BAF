...
### models/Gambler.rb - (75 offenses)
  ...
  * **Line # 31 - convention:** Metrics/AbcSize: Assignment Branch Condition size for statistics is too high. [<12, 13, 9> 19.85/17]

    ```rb
      def statistics()         ...
    ```

  * **Line # 31 - convention:** Metrics/MethodLength: Method has too many lines. [19/10]
  ...
  * **Line # 43 - convention:** Naming/VariableName: Use snake_case for variable names.
  ...
  * **Line # 48 - convention:** Naming/VariableName: Use snake_case for variable names.
  ...
  * **Line # 54 - convention:** Style/GuardClause: Use a guard clause (`return unless (cant_predicciones != 0)`) instead of wrapping the code inside a conditional expression.
...
### models/Match.rb - (33 offenses)
  ...
  * **Line # 18 - convention:** Layout/IndentationWidth: Use 2 (not 4) spaces for indentation.
  ...
  * **Line # 18 - convention:** Layout/LineLength: Line is too long. [166/120]
...
### models/Prediction.rb - (36 offenses)
  ...
  * **Line # 12 - convention:** Layout/IndentationWidth: Use 2 (not 7) spaces for indentation.
...
### models/Result.rb - (83 offenses)
  ...
  * **Line # 15 - convention:** Metrics/MethodLength: Method has too many lines. [15/10]

    ```rb
        def calculatePoints(prediction) ...
    ```

  * **Line # 15 - convention:** Naming/MethodName: Use snake_case for method names.
  ...
  * **Line # 16 - convention:** Layout/IndentationWidth: Use 2 (not -2) spaces for indentation.

    ```rb
    		t1GoalsP = prediction.team1_goals
    ```

  * **Line # 16 - warning:** Lint/UselessAssignment: Useless assignment to variable - `t1GoalsP`. Did you mean `t1GoalsR`?
  ...
  * **Line # 17 - warning:** Lint/UselessAssignment: Useless assignment to variable - `t2GoalsP`. Did you mean `t2GoalsR`?

    ```rb
    		t2GoalsP = prediction.team2_goals
    ```

  * **Line # 17 - convention:** Naming/VariableName: Use snake_case for variable names.
  ...
  * **Line # 19 - warning:** Lint/UselessAssignment: Useless assignment to variable - `t1GoalsR`. Did you mean `t1GoalsP`?
  ...
  * **Line # 20 - warning:** Lint/UselessAssignment: Useless assignment to variable - `t2GoalsR`. Did you mean `t2GoalsP`?

    ```rb
    		t2GoalsR = self.team2_goals
    ```

  * **Line # 20 - convention:** Naming/VariableName: Use snake_case for variable names.
  ...
  * **Line # 22 - convention:** Naming/VariableName: Use snake_case for variable names.
  ...
  * **Line # 26 - convention:** Layout/IndentationWidth: Use 2 (not -5) spaces for indentation.
  ...
  * **Line # 29 - convention:** Layout/IndentationWidth: Use 2 (not 1) spaces for indentation.

    ```rb
    			totalPoints += 1
    ```

  * **Line # 29 - convention:** Naming/VariableName: Use snake_case for variable names.
  ...
  * **Line # 32 - convention:** Naming/VariableName: Use snake_case for variable names.
  ...
  * **Line # 34 - convention:** Naming/VariableName: Use snake_case for variable names.
  ...
  * **Line # 39 - convention:** Layout/IndentationWidth: Use 2 (not 4) spaces for indentation.
  ...
  * **Line # 41 - convention:** Layout/IndentationWidth: Use 2 (not 4) spaces for indentation.
  ...
  * **Line # 52 - convention:** Layout/IndentationWidth: Use 2 (not 4) spaces for indentation.
  ...
  * **Line # 54 - convention:** Layout/IndentationWidth: Use 2 (not 4) spaces for indentation.
...
### server.rb - (92 offenses)
  ...
  * **Line # 13 - convention:** Metrics/ClassLength: Class has too many lines. [241/100]
  ...
  * **Line # 21 - convention:** Style/AndOr: Use `&&` instead of `and`.
  ...
  * **Line # 48 - convention:** Style/GlobalStdStream: Use `$stdout` instead of `STDOUT`.
  ...
  * **Line # 91 - convention:** Style/DoubleNegation: Avoid the use of double negation (`!!`).
  ...
  * **Line # 96 - convention:** Style/DoubleNegation: Avoid the use of double negation (`!!`).
  ...
  * **Line # 119 - convention:** Style/DoubleNegation: Avoid the use of double negation (`!!`).
  ...
  * **Line # 126 - warning:** Lint/UselessAssignment: Useless assignment to variable - `g1`.
  ...
  * **Line # 165 - convention:** Style/For: Prefer `each` over `for`.
  ...
  * **Line # 178 - convention:** Style/IdenticalConditionalBranches: Move `redirect to "/score"` out of the conditional.
  ...
  * **Line # 180 - convention:** Naming/VariableName: Use snake_case for variable names.

    ```rb
          cantPred = gambler.prediction.size - cant
    ```

  * **Line # 181 - convention:** Naming/VariableName: Use snake_case for variable names.

    ```rb
          flash[:notice] = "Se realizaron #{cantPred} predicciones"
    ```

  * **Line # 182 - convention:** Style/IdenticalConditionalBranches: Move `redirect to "/score"` out of the conditional.
  ...
  * **Line # 255 - convention:** Style/For: Prefer `each` over `for`.
...
### spec/test/test_Gambler_spec.rb - (22 offenses)
  ...
  * **Line # 27 - convention:** Naming/VariableNumber: Use normalcase for symbol numbers.

    ```rb
            let(:team_1) { Team.new(name: 'T3') }
    ```

  * **Line # 28 - convention:** Naming/VariableNumber: Use normalcase for symbol numbers.
...
### spec/test/test_Match_spec.rb - (50 offenses)
  ...
  * **Line # 10 - convention:** Naming/VariableNumber: Use normalcase for symbol numbers.
  ...
  * **Line # 33 - convention:** Layout/IndentationWidth: Use 2 (not 4) spaces for indentation.
...
### spec/test/test_Prediction_spec.rb - (30 offenses)
...
### spec/test/test_Result_spec.rb - (52 offenses)
...
### spec/test/test_Team_spec.rb - (7 offenses)
